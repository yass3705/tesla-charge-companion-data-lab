#!/usr/bin/env python3
"""Validate current official Connect&go Bassin de Pompey tariff rules."""
from __future__ import annotations
import argparse,hashlib,html,json,re,urllib.request
from datetime import datetime,timezone
from pathlib import Path
UA='Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 Chrome/140 Safari/537.36';HOME='https://bassinpompey.connectandgo.fr/';TARIFFS='https://bassinpompey.connectandgo.fr/tarifs/'
def fetch(u):
