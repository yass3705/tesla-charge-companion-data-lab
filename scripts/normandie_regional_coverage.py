...
def main():
    ...
    ps,praw,pfinal=fetch(SIEGE_TARIFF)
    ns,nraw,nfinal=fetch(SIEGE_2025)
    if min(ms,es,os_,ss,rs,hs,ps,ns)!=200:
        raise RuntimeError(f'HTTP failure mobisdec={ms} echarge={es} te61={os_} sde76={ss} rouen={rs} lehavre={hs} siegeTariff={ps} siege2025={ns}')

    require(mraw,'MobiSDEC','530 bornes','Tarifs','0,42','0,47','0,52','0,57','0,62','0,21','15min','minuit','7h00','10 € par badge',label='MobiSDEC current')
