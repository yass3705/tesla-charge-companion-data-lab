...
def main():
    ...
    text=plain(raw);require(text,'janvier 2026','E-TOTEM','40 points de charge','Mode Eco 3,7 kW','Normal ou Boost 7,4-22 kW','0,30 €','0,39 €','50 kW-99 kW','100-180 kW','0,45 €','0,49 €','10 minutes de franchise','1 € / 15 min','3 € / 15 min','limitée à 2 € maximum','22 h et 8 h')
