...
def main():
    ...
    if src['grand_lyon']['httpStatus']==200:
        # The current IZIVIA Grand Lyon tariff table is rendered client-side. urllib sees the
        # official application shell but not its numeric rows. Reachability remains a live transport
        # witness; the tariff values below are pinned from a manual official-page recheck.
        pass
