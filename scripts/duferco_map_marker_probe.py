...
Uses browser-origin POST without persisting any request headers/cookies. If the endpoint
...
def main():
    ...
    try:
        ...
        for name,s,w,n,e,z in AREAS:
            ...
            r=d.execute_async_script("""
              ...
              fetch(u,{method:'POST',credentials:'omit',headers:{'Accept':'application/json'},body:null})
    ...
    payload={'source':{'page':PAGE,'rangeEndpointTemplate':API,'method':'POST'},'security':{'accountCredentialsUsed':False,'requestHeadersPersisted':False,'cookiesPersisted':False,'hiddenAuthorizationExtracted':False},'areas':results}
