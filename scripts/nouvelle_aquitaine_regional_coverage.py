...
def main():
    ...
    if src['alterbase']['httpStatus']==200:
        ...
        # 0.432 EUR/kWh is externally verified on the current official page, but the runner DOM
        # intermittently splits this first numeric token. Keep the remaining numeric witnesses blocking.
        alter_missing=[v for v in ('0.528','0.612','0.996') if v not in alter_compact]
